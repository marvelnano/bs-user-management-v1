...
```
cd existing_repo
git remote add origin https://gitlab.com/Squad9752309/backend/bs-products-management-v1.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Squad9752309/backend/bs-products-management-v1/-/settings/integrations)
